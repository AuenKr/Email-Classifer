          ...
          <div className="flex gap-4 border border-gray-200 rounded-lg p-4 dark:border-gray-800 m-3 hover:cursor-pointer">
            <div className="flex-1">
              <div className="flex items-center justify-between mb-3">
                <div className="font-medium hover:underline underline-offset-4">
                  {emailDetail.From}
                </div>
              ...
              <div className="text-md text-gray-500 dark:text-gray-400 text-clip truncate line-clamp-2 text-wrap">
                {emailDetail.snippet}
              </div>
            </div>
          </div>
